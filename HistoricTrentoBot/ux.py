...
MSG_TIME_WILL_START_ON_PRESS = "⏱ Il cronometro partirà appena premete il pulsante."
MSG_GO = '🏃‍♂️🏃‍♀️ Si parte!'
...
MSG_START_TIME_MISSION = "⏱ Via al tempo per questa missione!"
...
MSG_ELLAPSED_TIME_MISSION = '⏱ Tempo impiegato per questa missione: {}'
...
MSG_END = '🏆 Bravi! Avete completato la caccia al tesoro in *{}*!! ({} tempo + {} penalità)'
